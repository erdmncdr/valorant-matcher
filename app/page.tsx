    ...
    <div className="min-h-screen bg-gradient-to-b from-valorant-darker via-valorant-dark to-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="border-valorant-red/20 bg-card/50 backdrop-blur hover:border-valorant-red/40 transition-colors">
            <CardHeader>
              ...
              <CardTitle className="text-white">{t.home.teamAndSoloListings}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="border-valorant-cyan/20 bg-card/50 backdrop-blur hover:border-valorant-cyan/40 transition-colors">
            <CardHeader>
              ...
              <CardTitle className="text-white">{t.home.safeAndModerated}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="border-valorant-purple/20 bg-card/50 backdrop-blur hover:border-valorant-purple/40 transition-colors">
            <CardHeader>
              ...
              <CardTitle className="text-white">{t.home.reputationSystem}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
          ...
          <Card className="border-yellow-500/20 bg-card/50 backdrop-blur hover:border-yellow-500/40 transition-colors">
            <CardHeader>
              ...
              <CardTitle className="text-white">{t.home.builtInChat}</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg">{t.home.howItWorksSubtitle}</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-400">{t.home.step1Desc}</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-400">{t.home.step2Desc}</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-400">{t.home.step3Desc}</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20">
        <Card className="border-valorant-red/30 bg-gradient-to-r from-valorant-red/10 to-valorant-purple/10 backdrop-blur">
          <CardHeader className="text-center pb-8 pt-12">
            <CardTitle className="text-4xl text-white mb-4">{t.home.readyToFindTeam}</CardTitle>
