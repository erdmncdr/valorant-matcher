        ...
        <Tabs defaultValue="listings" className="space-y-6">
          ...
          <TabsContent value="listings" className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-foreground">{t.myListings.activeListings}</h3>
            ...
            {myListings.filter(listing => {
              ...
              <div className="space-y-4 mt-8">
                <h3 className="text-lg font-semibold text-muted-foreground">{t.myListings.expiredListings}</h3>
                <div className={listingViewMode === "grid" ? "grid grid-cols-1 md:grid-cols-2 gap-4" : "grid grid-cols-1 gap-4"}>
                  {myListings.filter(listing => {
                    const isExpired = new Date(listing.expiresAt) < new Date()
                    const isClosed = listing.status !== "OPEN"
          ...
          <TabsContent value="applications" className="space-y-4">
            ...
            {/* Active Applications */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-foreground">{t.myListings.activeApplications}</h3>
            ...
            {myApplications.filter(application => {
              ...
              <div className="space-y-4 mt-8">
                <h3 className="text-lg font-semibold text-muted-foreground">{t.myListings.expiredApplications}</h3>
                <div className={applicationViewMode === "grid" ? "grid grid-cols-1 lg:grid-cols-2 gap-4" : "grid grid-cols-1 gap-4"}>
                  {myApplications.filter(application => {
                    const listing = application.listing
                    const isExpired = listing && new Date(listing.expiresAt) < new Date()
