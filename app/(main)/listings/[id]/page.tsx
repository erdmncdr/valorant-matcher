  ...
  const applyToListing = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "The listing owner will see your application",
      })
  ...
  const closeListing = async () => {
    try {
      ...
      toast({
        ...
        description: "Your listing has been closed",
      })
            ...
            <Card className="border-valorant-red/20">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-gray-400 mb-1">Rank Range</p>
                ...
                <div>
                  <p className="text-gray-400 mb-2">Posted by</p>
                ...
                {!isOwner && listing.status === "OPEN" && (
                  <div className="space-y-3 pt-4">
                    <Textarea
                      ...
                      placeholder="Send a message with your application (optional)"
                      rows={3}
                      disabled={hasApplied}
                    />
                    <Button
              ...
              <CardContent>
                {!isOwner ? (
                  <p className="text-sm text-gray-400 text-center py-4">
                    Only the listing owner can see applications
                  </p>
